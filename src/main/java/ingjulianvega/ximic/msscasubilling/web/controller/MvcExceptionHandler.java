...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(BillingParameters billingParameters) {
    ...
    public ResponseEntity<ApiError> validationErrorHandler(BillingException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(billingParameters.getApi())
